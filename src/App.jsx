    ...
    <div className="App">
      ...
      <header className="hero">
        ...
        <motion.p initial="hidden" animate="visible" variants={fadeIn} transition={{ delay: 0.3 }}>
          EmpowerHer Tech aide les jeunes femmes au Burundi à se protéger, accéder à des formations et recevoir une assistance confidentielle.
        </motion.p>
      ...
      <section className="services">
        ...
        {services.map((service, i) => (
          <motion.div key={i} className="service" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn} transition={{ delay: i*0.2 }}>
            <img src={serviceImages[i]} alt={service.titre} />
            <h3>{service.titre}</h3>
            <p>{service.desc}</p>
          </motion.div>
        ))}
      ...
      <section className="contact">
        ...
        <motion.div className="contact-info" initial="hidden" animate="visible" variants={fadeIn} transition={{ delay: 0.2 }}>
          <p><strong>Siège :</strong> Avenue de l’Indépendance, Bujumbura, Burundi</p>
          <p><strong>Bureaux :</strong> Gitega, Ngozi</p>
          ...
          <p><strong>Nos services :</strong> Protection, santé sexuelle, éducation & environnement, recyclage, adaptabilité climatique.</p>
        </motion.div>
      </section>
    </div>
  );
